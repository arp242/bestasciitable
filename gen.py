...
<body>
    ...
    <div id="intro">
        <div>
            <p>To understand why Control+i inserts a tab in your terminal you
            need to understand ASCII, and to understand ASCII you need know a
            bit about its history and the world it was developed in. Please bear
            with me (or <a href="#table">just go the table</a>).</p>
